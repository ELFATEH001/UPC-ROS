...
def launch_setup(context, *args, **kwargs):
    ...
    sub3_node = Node(
        name='subscriber_node3',
        package='pubsub_custom_param',
        executable='subscriber_class',
        output='screen',
        condition=LaunchConfigurationEquals('number_of_subscribers_argument', '3')
        #condition=IfCondition(number_of_subscribers_argument)
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value='1',
            description='Specifies the number of subscribers, either 1 or 2 or 3'
            #default_value='true',
