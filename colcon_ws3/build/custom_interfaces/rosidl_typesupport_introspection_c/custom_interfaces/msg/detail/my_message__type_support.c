...
static rosidl_typesupport_introspection_c__MessageMember custom_interfaces__msg__MyMessage__rosidl_typesupport_introspection_c__MyMessage_message_member_array[2] = {
  {
    "center",  // name
    ...
    offsetof(custom_interfaces__msg__MyMessage, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__MyMessage, name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, MyMessage)() {
  custom_interfaces__msg__MyMessage__rosidl_typesupport_introspection_c__MyMessage_message_member_array[0].members_ =
