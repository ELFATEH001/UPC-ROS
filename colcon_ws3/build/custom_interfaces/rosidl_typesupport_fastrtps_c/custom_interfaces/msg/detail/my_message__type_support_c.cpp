...
#include "custom_interfaces/msg/detail/my_message__rosidl_typesupport_fastrtps_c.h"
...
using _MyMessage__ros_msg_type = custom_interfaces__msg__MyMessage;
...
size_t get_serialized_size_custom_interfaces__msg__MyMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MyMessage__ros_msg_type * ros_message = static_cast<const _MyMessage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MyMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__MyMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__MyMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__MyMessage;
    is_plain =
      (
...
static size_t _MyMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__MyMessage(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, MyMessage)() {
