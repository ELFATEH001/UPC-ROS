...
{
  new (message_memory) custom_interfaces::msg::MyMessage(_init);
}

void MyMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::MyMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyMessage_message_member_array[2] = {
  {
    ...
    offsetof(custom_interfaces::msg::MyMessage, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::MyMessage, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces::msg::MyMessage),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MyMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, MyMessage)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::MyMessage_message_type_support_handle;
}
